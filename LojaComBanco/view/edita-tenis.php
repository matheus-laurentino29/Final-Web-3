...
<body class="bg-white">
    ...
    <form name="edTenis" method="post" action="../model/editaT.php" align="center">
        ...
        <div class="col-md-12 order-md-1">
            <form class=edita action="../model/editaT.php" method="post">
                ...
                <div class="col-md-6 mb-3">
                        <label class="font-weight-bold" for="cadarco">Cadarco</label>
                        <select class="custom-select d-block w-100" id="cadarco" name="cadarco" required="">
                            <option value="<?php echo $cadarco; ?>"><?php echo $cadarco; ?></option>
